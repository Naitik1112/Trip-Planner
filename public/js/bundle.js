    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 8:
          _context.prev = 8;
          _context.t0 = _context["catch"](0);
          errorMessage = _context.t0 && _context.t0.response && _context.t0.response.data && _context.t0.response.data.message ? _context.t0.response.data.message : 'Something went wrong';
...
// };
/* eslint-disable */
var stripe = Stripe('pk_test_51QVbHsB7mecCB9wjHTLr3iUFnoEd3ARPyDI1jkauth27KWcyAHEoSqq0pIfTfYedZgOZR6d5fgqe7Q5XK7vWQF3100dh7fvnFH');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 9:
          ...
          errorMessage = _context.t0 && _context.t0.response && _context.t0.response.data && _context.t0.response.data.message ? _context.t0.response.data.message : 'Something went wrong during checkout!';
          (0, _alerts.showAlert)('error', errorMessage);
        case 14:
        case "end":
          return _context.stop();
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    ...
    var tourId = e.target.dataset.tourId; // Ensure the button has a `data-tour-id` attribute
    if (!tourId) {
      (0, _alerts.showAlert)('error', 'Tour ID is missing!');
      e.target.textContent = 'Book tour';
      return;
    }
    bookTour(tourId).finally(function () {
      e.target.textContent = 'Book tour';
    });
  });
}
